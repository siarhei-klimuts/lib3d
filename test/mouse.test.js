...
describe('mouse.js', function() {
    ...
    it('should find a box', function() {
        ...
        var intersected = mouse.getIntersected([cube], false, [THREE.Mesh], camera);
